...
//filter the book in database
$sql = "select * from book where $option like '%$keyword%'";
...
$sqlBook = "select * from book where $option like '%$keyword%' order by BOO_amount desc limit ".$startPage.",".$size;
...
<body onload="checkModel()">
	...
	?>
	<!-- show previous page -->
	<a href="searchBookAdmin.php?page=1">Previous</a>
	<?php }else{ ?>
	<a href="searchBookAdmin.php?page=<?php echo $page-1;?>">Previous</a>
	<?php } ?>
	...
	<?php for($i=$start; $i<=$end; $i++){
		if($i==$page){?>
			<a href="searchBookAdmin.php?page=<?php echo $i;?>"><?php echo '['.$i.']';?></a>
	<?php
	}else{
	?>
	<a href="searchBookAdmin.php?page=<?php echo $i;?>"><?php echo $i;?></a>
	...
	<a href="searchBookAdmin.php?page=<?php echo $pagecount;?>">Next</a>
	<?php }else{ ?>
	<a href="searchBookAdmin.php?page=<?php echo $page+1;?>">Next</a>
