...
<body>
	...
	?>
	<!-- show previous page -->
	<a href="searchBook.php?page=1">Previous</a>
	<?php }else{ ?>
	<a href="searchBook.php?page=<?php echo $page-1;?>">Previous</a>
	<?php } ?>
	...
	<?php for($i=$start; $i<=$end; $i++){
		if($i==$page){?>
			<a href="searchBook.php?page=<?php echo $i;?>"><?php echo '['.$i.']';?></a>
	<?php
	}else{
	?>
	<a href="searchBook.php?page=<?php echo $i;?>"><?php echo $i;?></a>
	...
	<!-- show next page -->
	<a href="searchBook.php?page=<?php echo $pagecount;?>">Next</a>
	<?php }else{ ?>
	<a href="searchBook.php?page=<?php echo $page+1;?>">Next</a>
